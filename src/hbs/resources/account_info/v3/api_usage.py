...
from ....types.account_info.v3.api_usage_get_daily_usage_response import APIUsageGetDailyUsageResponse
    ...
    def get_daily_usage(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=APIUsageGetDailyUsageResponse,
        )
...
class APIUsageResourceWithRawResponse:
    def __init__(self, api_usage: APIUsageResource) -> None:
        ...
        self.get_daily_usage = to_raw_response_wrapper(
            api_usage.get_daily_usage,
        )
...
class AsyncAPIUsageResourceWithRawResponse:
    def __init__(self, api_usage: AsyncAPIUsageResource) -> None:
        ...
        self.get_daily_usage = async_to_raw_response_wrapper(
            api_usage.get_daily_usage,
        )
...
class APIUsageResourceWithStreamingResponse:
    def __init__(self, api_usage: APIUsageResource) -> None:
        ...
        self.get_daily_usage = to_streamed_response_wrapper(
            api_usage.get_daily_usage,
        )
...
class AsyncAPIUsageResourceWithStreamingResponse:
    def __init__(self, api_usage: AsyncAPIUsageResource) -> None:
        ...
        self.get_daily_usage = async_to_streamed_response_wrapper(
            api_usage.get_daily_usage,
        )
